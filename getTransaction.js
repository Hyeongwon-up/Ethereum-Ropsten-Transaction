...
web3.eth.getTransactionCount(send_account, (err, txCount) => { // (1)
  ...
  web3.eth.getTransaction('0x93480581bb9bd5108e58594c24f25c79bf0557d99784d73962e3fe9d804acc96').then(console.log);

  web3.eth.getTransactionReceipt('0x93480581bb9bd5108e58594c24f25c79bf0557d99784d73962e3fe9d804acc96').then(console.log);
